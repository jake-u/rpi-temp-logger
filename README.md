...
![example physical implementation](https://github.com/jake-u/rpi-temp-logger/blob/main/readme_assets/exinterface.png?raw=true)
...
![example temperature graph](https://github.com/jake-u/rpi-temp-logger/blob/main/readme_assets/extemp2.png?raw=true)
![example humidity graph](https://github.com/jake-u/rpi-temp-logger/blob/main/readme_assets/exhum.png?raw=true)
...
# Features
## Zoomable temperature and humidity graphs
![example temperature graph](https://github.com/jake-u/rpi-temp-logger/blob/main/readme_assets/extemp1.png?raw=true)
...
![configuration screen](https://github.com/jake-u/rpi-temp-logger/blob/main/readme_assets/exconf.png?raw=true)
- System time
- Display brightness
- Display sleep time
...
![memory inspector](https://github.com/jake-u/rpi-temp-logger/blob/main/readme_assets/exmeminspec.png?raw=true)
...
`font.h` contains the definitions for the pixel font and other hardcoded graphics.
